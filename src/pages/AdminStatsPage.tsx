...
import {
  ...
  type LeagueStatsSnapshot, type StatsPlayer,
} from '../hooks/useLeagueStats';
import { deriveLeagueStats, COMPLETED_STATUSES, winPct } from '../lib/leagueStats';
...
function useDerived(data: LeagueStatsSnapshot | undefined, asOf: number) {
  return useMemo(() => (data ? deriveLeagueStats(data, asOf) : null), [data, asOf]);
}
