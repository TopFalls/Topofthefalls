export const LEAGUE = {
  ...
  rulesSummary: [
    ...
    'If you challenge up and lose, you cannot issue another challenge for 7 days unless you complete a defending match first, win or lose. You can still receive and accept challenges during this wait. Accepting alone does not end the wait.',
