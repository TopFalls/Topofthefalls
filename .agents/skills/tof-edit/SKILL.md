...
| TOC.Monster | `cdalin1985/Codex-agent0toc` | `toc-app` | `toc1` |
...
If Carl asks for something that contradicts `AGENTS.md` league canon — the
clearest example being anything that reintroduces seasons — **he is changing the
rule, and he's allowed to.** Build it, update the canon section of `AGENTS.md` in
